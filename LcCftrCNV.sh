...
MAPPABILITY_BED="/home/administrator/Lc/LcDatabase_hg38/CNV_hg38/CFTR_cnv/CFTR_mappability.bed"
SEG_BED="/home/administrator/Lc/LcDatabase_hg38/CNV_hg38/CFTR_cnv/segdups.noalt.bed"
...
python LcCftrCNV_html.py ${sample}_CNV_prioritized.tsv ${sample}_CNV.html
